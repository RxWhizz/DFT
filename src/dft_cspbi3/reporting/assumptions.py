"""Generate assumptions.md — scientific assumptions and validity range."""
...
def generate_assumptions(
    ...
    """Write assumptions.md and return its path.

    Args:
        params: Optional calculation parameters dict.
...
|-----------|------------|----------------------|----------------|
| Plane-wave cutoff | {params.get('ecut_eV', 450)} eV | < 1 meV/atom vs. Ecut convergence | < 1 meV/atom |
| k-point mesh | {params.get('kpts', [6,6,6])} | < 1 meV/atom vs. k-mesh convergence | < 1 meV/atom |
