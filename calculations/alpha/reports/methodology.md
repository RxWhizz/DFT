...
*alpha-CsPbI₃ — flujo DFT con GPAW/ASE*
...
PBEsol se usa en relajacion estructural y calculos SCF. PBEsol = PBE revisado para solidos cristalinos (Perdew et al., 2008). Constantes de red y energia cohesiva mejoran vs PBE. Energias de atomizacion molecular bajan algo.
...
**Malla**: 6×6×6 Monkhorst-Pack centrada en Γ

Zona Brillouin usa malla Monkhorst-Pack uniforme. Malla Γ sirve con simetria
inversion temporal. DOS usa malla mas densa: 6×6×6 → 12×12×12.
...
**Modo**: perturbative (spinorbit_eigenvalues)
