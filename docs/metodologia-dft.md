# Metodología DFT: caracterización profunda

Aquí está la parte de cálculo pesado: el workflow que caracteriza a fondo un
material una vez el cribado lo ha seleccionado, más las tablas de equivalencia
con VASP. Vivía en el README, pero es material de referencia y no una
descripción de lo que hace el proyecto. Para eso está [el README](../README.md).
...
| `POTCAR` (Cs_sv, Pb_d, I) | nada que configurar: los datasets de serie ya son esos | `Cs.PBE` trae 9 electrones de valencia, `Pb.PBE` 14 con el 5d, `I.PBE` 7 |
